            ...
            <div className='max-w-[1095px] border-2 border-[graytext] rounded-xl'>
                <div className='max-w-[1080px] border-2 border-[graytext] rounded-xl m-2'>
                    <div className='relative mt-2 max-w-[300px] mx-auto'>
                        <input ref={ref} onChange={(e)=>setSearchValue(e.target.value)} className='w-full py-[12px] px-2 bg-[#f0e3d8] rounded-xl focus:outline-[graytext]' value={searchValue} type="text" placeholder='Искать...'/>
                        {searchValue && <svg onClick={onClear} className='max-w-[20px] absolute right-[10px] top-[15px] cursor-pointer'
